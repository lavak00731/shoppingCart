...
const templaterunner = (prod:any, i:number) => {
    ...
    const item = `<div class="relative">
                        ...
                        <p class="mb-3">
                            ...
                            <span class="font-poppins text-review-color text-[11px] leading-[16.5px] lg:text-lg">${prod.reviews.length} Reviews</span>
                        </p>             
                        <p class="font-poppins font-[500] text-md mb-2">$ ${prod.price}</p>
                    </div>`;
