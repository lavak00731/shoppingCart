...
const init =  async () => {
  ...
  if(request.length > 0) {
    app!.innerHTML = `<div id="gralWrapper" class="wrapper lg:overflow-x-auto lg:w-7/8 lg:mx-auto"><ul id="list" class="mb-6 grid grid-cols-2 md:grid-cols-4 gap-4 lg:flex  lg:pb-8"></ul></div>`;
